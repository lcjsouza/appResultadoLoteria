          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                BotaoHome(
                    texto: 'Lotomania',
                    backgroundColor: Color(0xFFf78100),
                    textColor: Color(0xFFFFFFFF),
                    jogo: 'lotomania'),
                Container(height: 50),
                BotaoHome(
                    texto: 'Quina',
                    backgroundColor: Color(0xFF260085),
                    textColor: Color(0xFFFFFFFF),
                    jogo: 'quina'),
                Container(height: 50),
                BotaoHome(
                    texto: 'Mega Sena',
                    backgroundColor: Color(0xFF209869),
                    textColor: Color(0xFFFFFFFF),
                    jogo: 'megasena'),
                Container(height: 50),
                BotaoHome(
                ...
                BotaoHome(
                    texto: 'Dia de Sorte',
                    backgroundColor: Color(0xFFcb852b),
                    textColor: Color(0xFFFFFFFF),
                    jogo: 'diasorte'),
                Container(height: 50),
                BotaoHome(
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            shape: RoundedRectangleBorder(
              borderRadius:
                  BorderRadius.circular(50), // Remove o arredondamento
            ),
          ),
          child: SizedBox(
