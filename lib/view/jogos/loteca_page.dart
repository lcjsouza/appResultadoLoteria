...
class LotecaPage extends StatefulWidget {
  const LotecaPage({super.key});

  @override
  State<LotecaPage> createState() => _LotecaPageState();
}

class _LotecaPageState extends State<LotecaPage> {
...
// funções para navegação
  void proximoConcurso() {
    if (concursoAtual != null) {
      apiLoteriaData('loteca/${concursoAtual! + 1}');
    }
  }
          ...
          child: Padding(
            ...
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: Color(0xFFfb1f00), width: 2)),
              child: Container(
                padding:
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            apiLoteriaData('loteca/$concurso');
                            Future.delayed(Duration(milliseconds: 500), () {
                              _textController.clear();
                            });
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xFFfb1f00),
