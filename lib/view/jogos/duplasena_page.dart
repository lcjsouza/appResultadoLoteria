...
class DuplaSenaPage extends StatefulWidget {
  ...
  @override
  State<DuplaSenaPage> createState() => _DuplaSenaPageState();
}

class _DuplaSenaPageState extends State<DuplaSenaPage> {
          ...
          child: Padding(
            ...
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: Color(0xFFa61324), width: 2)),
              child: Container(
                padding:
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            apiLoteriaData('duplasena/$concurso');
                            Future.delayed(Duration(milliseconds: 500), () {
                              _textController.clear();
                            });
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xFFa61324),
                    ...
                    Column(
                      ...
                      children: isLoading
                        ...
                        DezenasSorteadasWidget(
                          ...
                          numeros: List<String>.from(
                              resultado?['listaDezenas'] ?? [])
                            ..sort(),
                          sorteioDois: List<String>.from(
