...
class DiaSortePage extends StatefulWidget {
  ...
  @override
  State<DiaSortePage> createState() => _DiaSortePageState();
}

class _DiaSortePageState extends State<DiaSortePage> {
          ...
          child: Padding(
            ...
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: Color(0xFFcb852b), width: 2)),
              child: Container(
                padding:
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            apiLoteriaData('diadesorte/$concurso');
