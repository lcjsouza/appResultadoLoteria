...
class FederalPage extends StatefulWidget {
  const FederalPage({super.key});

  @override
  State<FederalPage> createState() => _FederalPageState();
}

class _FederalPageState extends State<FederalPage> {
  ...
  void proximoConcurso() {
    if (concursoAtual != null) {
      apiLoteriaData('federal/${concursoAtual! + 1}');
    }
  }
          ...
          child: Padding(
            ...
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: Color(0xFF105099), width: 2)),
              child: Container(
                padding:
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            apiLoteriaData('federal/$concurso');
                            Future.delayed(Duration(milliseconds: 500), () {
                              _textController.clear();
                            });
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Color(0xFF105099),
